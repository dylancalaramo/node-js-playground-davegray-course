...
const { router: refresh } = require("./routes/refresh.js");
const { router: logout } = require("./routes/logout.js");
...
//you need cookieparser to allow your controllers
...
//use a middleware to verify JWT tokens
//for the employees api
//works on all html request headers
